...
// if (menuAuthDto == null || StringUtils.isBlank(menuAuthDto.getAuthCode()) ||
// StringUtils.isBlank(menuAuthDto.getMenuCode())) {
...
// if (menuAuthDto == null || menuAuthDto.getPkMenuAuthCode() == null || menuAuthDto.getIsActive()
// == null) {
