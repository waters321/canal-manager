...
public class CanalServerConfig {
  ...
  public void setCanalServerConfiguration(String canalServerConfiguration) {
    this.canalServerConfiguration =
        canalServerConfiguration == null ? null : canalServerConfiguration.trim();
  }
  ...
  public void setStandbyServerConfiguration(String standbyServerConfiguration) {
    this.standbyServerConfiguration =
        standbyServerConfiguration == null ? null : standbyServerConfiguration.trim();
  }
