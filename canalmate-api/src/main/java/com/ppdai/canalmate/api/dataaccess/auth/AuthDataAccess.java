...
//
// // 是否存在
// private static String selectAuthByCodeSql = "SELECT COUNT(*) FROM TB_AUTH WHERE AUTH_CODE = ? AND
// ISACTIVE = 1";
//
// // 新增
...
// // 判断是否已存在
// Integer count = mysqlJdbcTemplate.queryForObject(selectAuthByCodeSql, Integer.class,
// authDto.getAuthCode());
// if (count != 0) {
// return new ResultResponse(false, UserReponseEnum.AUTH_EXIST.getResCode(),
// UserReponseEnum.AUTH_EXIST.getResMsg());
// }
//
// // 新增
// int i = mysqlJdbcTemplate.update(createAuthSql, new Object[]{authDto.getAuthCode(),
// authDto.getAuthName()});
//
...
// StringBuffer selectAuthSql = new StringBuffer("SELECT PK_AUTH_ID, AUTH_CODE, AUTH_NAME,
// CREATE_USER, UPDATE_USER, INSERTTIME, UPDATETIME, ISACTIVE FROM TB_AUTH WHERE 1 = 1 ");
...
// rs.getString(5), DateUtil.formatDate(rs.getString(6)), DateUtil.formatDate(rs.getString(6)),
// rs.getByte(8));
...
// int i = mysqlJdbcTemplate.update(updateAuthSql, new Object[]{authDto.getIsActive(),
// authDto.getPkAuthId()});
//
// return i == 1 ? new ResultResponse(true, UserReponseEnum.SUCCEED.getResCode(),
// UserReponseEnum.SUCCEED.getResMsg())
