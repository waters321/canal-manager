...
public class UserRoleDto extends BaseDto {
  ...
  public UserRoleDto(Integer pkUserRoleId, String userCode, String userName, String roleCode,
      String roleName, String createUser, String updateUser, String insertTime, String updateTime,
      Byte isActive) {
    this.pkUserRoleId = pkUserRoleId;
    this.userCode = userCode;
    this.userName = userName;
