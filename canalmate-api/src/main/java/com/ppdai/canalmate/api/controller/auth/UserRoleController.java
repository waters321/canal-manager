...
public class UserRoleController {
  ...
  public ResultResponse inserUserRole(@ModelAttribute UserRoleDto userRoleDto,
      HttpServletRequest request) {
    if (userRoleDto == null || StringUtils.isBlank(userRoleDto.getUserCode())
        || StringUtils.isBlank(userRoleDto.getRoleCode())) {
  ...
  // 删除(角色和用户的匹配)
  @ApiOperation(value = "根据PkUserRoleId，删除角色和用户的匹配", httpMethod = "POST",
