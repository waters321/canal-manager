...
public class UserAuthDto extends BaseDto {
  ...
  public UserAuthDto(Integer pkUserAuthCode, String userCode, String userName, String authCode,
      String authName, String createUser, String updateUser, String insertTime, String updateTime,
      Byte isActive) {
    this.pkUserAuthCode = pkUserAuthCode;
    this.userCode = userCode;
    this.userName = userName;
