...
//
// // 菜单权限是否已存在
// private static String selectMenuAuthByCodeSql = "SELECT COUNT(*) FROM TB_MENU_AUTH WHERE
// MENU_CODE = ? AND AUTH_CODE = ? AND ISACTIVE = 1";
//
// // 新增菜单权限
// private static String createMenuAuthSql = "INSERT INTO TB_MENU_AUTH(MENU_CODE, MENU_NAME,
// AUTH_CODE, AUTH_NAME) VALUES (?,?,?,?)";
//
// // 删除菜单权限
// private static String deleteMenuAuthSql = "UPDATE TB_MENU_AUTH SET ISACTIVE = 0 WHERE
// PK_MENU_AUTH_CODE = ?";
//
// private static String updateMenuAuthSql = "UPDATE TB_MENU_AUTH SET ISACTIVE = ? WHERE
// PK_MENU_AUTH_CODE = ?";
//
// /**
// * 删除菜单权限
...
// int i = mysqlJdbcTemplate.update(deleteMenuAuthSql, new
// Object[]{menuAuthDto.getPkMenuAuthCode()});
//
// return i == 0 ? new ResultResponse(false, UserReponseEnum.FAIL.getResCode(),
// UserReponseEnum.FAIL.getResMsg())
// : new ResultResponse(true, UserReponseEnum.SUCCEED.getResCode(),
...
// int i = mysqlJdbcTemplate.update(updateMenuAuthSql, new Object[]{menuAuthDto.getIsActive(),
// menuAuthDto.getPkMenuAuthCode()});
//
// return i == 0 ? new ResultResponse(false, UserReponseEnum.FAIL.getResCode(),
// UserReponseEnum.FAIL.getResMsg())
// : new ResultResponse(true, UserReponseEnum.SUCCEED.getResCode(),
...
// StringBuffer selectMenuAuthSql = new StringBuffer("SELECT PK_MENU_AUTH_CODE, MENU_CODE,
// MENU_NAME, AUTH_CODE, AUTH_NAME, CREATE_USER, UPDATE_USER, INSERTTIME, UPDATETIME, ISACTIVE FROM
// TB_MENU_AUTH WHERE 1 = 1 ");
...
// MenuAuthDto MenuAuthDto = new MenuAuthDto(rs.getInt(1), rs.getString(2), rs.getString(3),
// rs.getString(4), rs.getString(5)
// , rs.getString(6), rs.getString(7), DateUtil.formatDate(rs.getString(8)),
// DateUtil.formatDate(rs.getString(9)), rs.getByte(10));
...
// }
// int i = mysqlJdbcTemplate.update(createMenuAuthSql, new Object[]{menuAuthDto.getMenuCode(),
// menuDtoList.get(0).getMenuName(), menuAuthDto.getAuthCode(), authDtoList.get(0).getAuthName()});
//
