...
// * */
// public List<CanalClientStatus> getCanalClientStatusBeanList(String
// canal_id,List<ZKDestinationBean> zKDestinationBeanList) {
...
// }
// DestinationsConfig
// destinationsConfig=processMonitorService.selectDestinationsConfigByArgs(argsMap);
// //根据destination id，查询client config信息，一个destination唯一对应一个client
//
//
// //从每个destination中取 cluster 节点的状态
// ZKDestinationClientRunningNode
// clientRunningNode=zKDestinationBean.getzKDestinationClientRunningNode();
...
// Map<String,String> argsMap=new HashMap<String,String>();
// argsMap.put("canal_id", canal_id);
// List<DestinationsConfig>
// destinationList=processMonitorService.selectDestinationConfigByArgs(argsMap);
...
// * */
// public static List<CanalServerConfigShow>
// getCanalServerStatusBeanList(List<CanalServerConfigShow> canalServerConfigShowList) {
//
...
// String
// zkAddress=CanalPropertyUtils.getPropertyValueByKey(canalServerConfig.getCanalServerConfiguration(),"canal.zkServers");
...
// String
// master_canal_ip=CanalPropertyUtils.getPropertyValueByKey(canalServerConfig.getCanalServerConfiguration(),"canal.ip");
// String
// standby_canal_ip=CanalPropertyUtils.getPropertyValueByKey(canalServerConfig.getStandbyServerConfiguration(),"canal.ip");
