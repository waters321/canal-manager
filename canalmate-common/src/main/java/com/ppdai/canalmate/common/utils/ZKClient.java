...
public class ZKClient implements Watcher {
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    //
    // String
    // DESTINATION_RUNNING_NODE_PATH=ZookeeperPathUtils.getDestinationServerRunning(destinationName);
    ...
    // if (result == null) {
    // logger.debug("=============没有server运行该dest,DESTINATION_RUNNING_NODE
    ...
    //
    // List<ZKDestinationClusterNode> zKDestinationClusterNodeList=new
    // ArrayList<ZKDestinationClusterNode>();
    //
    // String
    // DESTINATION_CLUSTER_ROOT_PATH=ZookeeperPathUtils.getDestinationClusterRoot(destinationName);
    ...
    //
    // ZKDestinationClientRunningNode zKDestinationClientRunningNode=new
    // ZKDestinationClientRunningNode();
    // String
    // clientRunningNodePath=ZookeeperPathUtils.getDestinationClientRunning(destinationName,CanalConstants.clientId);
    ...
    // zKDestinationClientRunningNode=JSON.parseObject(result,
    // ZKDestinationClientRunningNode.class);
    // }
    ...
    // boolean isSuccess = test.createNode(parentPath, "abc", Ids.OPEN_ACL_UNSAFE,
    ...
    //
    // // 创建子节点
    // isSuccess = test.createNode(childrenPath, String.valueOf(System.currentTimeMillis()),
    ...
    // Thread.sleep(1000);
    // //创建临时有序子节点
    // test.createNode(childrenPath, String.valueOf(System.currentTimeMillis()),
